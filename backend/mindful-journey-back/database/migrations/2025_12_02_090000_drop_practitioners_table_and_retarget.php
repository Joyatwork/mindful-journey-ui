...
return new class extends Migration {
    public function up(): void
    {
        ...
        if (Schema::hasTable('appointments')) {
            ...
            if (Schema::hasColumn('appointments', 'practitioner_id')) {
                try { DB::statement('ALTER TABLE appointments DROP FOREIGN KEY appointments_practitioner_id_foreign'); } catch (\Throwable $e) { }
            }
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('appointments') && Schema::hasTable('practitioners')) {
            ...
            try { DB::statement('ALTER TABLE appointments DROP FOREIGN KEY appointments_specialist_id_foreign'); } catch (\Throwable $e) { }
            try { DB::statement('ALTER TABLE appointments DROP FOREIGN KEY appointments_practitioner_id_foreign'); } catch (\Throwable $e) { }
            Schema::table('appointments', function (Blueprint $table) {
                if (Schema::hasColumn('appointments', 'specialist_id')) {
