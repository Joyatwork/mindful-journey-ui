<?php
// Insert Joy-only challenges into mindful_journey.challenges and update map
...
try {
    ...
    // connect to Joy schema for reading
    ...
    // Remap challenge_id in challenge_user and other tables if present
