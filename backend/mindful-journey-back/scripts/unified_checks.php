...
try {
    ...
    try {
        ...
        echo "mood_entries check failed: " . $e->getMessage() . "\n";
    }
    ...
    try {
        ...
        echo "employees check failed: " . $e->getMessage() . "\n";
    }
    ...
    try {
        ...
        echo "challenge_user check failed: " . $e->getMessage() . "\n";
    }
    ...
    try {
        ...
        echo "campaign_participants check failed: " . $e->getMessage() . "\n";
    }
