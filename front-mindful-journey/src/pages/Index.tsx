...
const Index = () => {
  ...
  const items = res?.data || [];
      ...
      if (!id) {
        // Pas de défi en base: on laisse l’appelant gérer en ouvrant la vue sans suivi
        return null;
      }
      setCurrentChallengeId(id);
      return id;
    } catch (e) {
      console.warn('Impossible de récupérer un défi:', e);
      toast("Aucun défi disponible en base — ouverture du module sans suivi.");
      return null;
    }
  };
      ...
      case 'meditation':
        {
          ...
          if (id) {
            ...
            toast("Ouverture de la méditation sans défi associé.");
          }
        }
      ...
      case 'breathing':
        {
          ...
          if (id) {
            ...
            toast("Ouverture de la respiration sans défi associé.");
          }
        }
      ...
      case 'sleep':
        {
          ...
          if (id) {
            ...
            toast("Ouverture de la routine sommeil sans défi associé.");
          }
        }
